...
organise_update_facebook_prediction:
	...
	# Move
	cp stock-statistical-analysis/update-facebook-prediction.py build/site-packages
...
organise_update_technology_prediction:
	...
	# Move
	cp stock-statistical-analysis/update-technology-prediction.py build/site-packages
